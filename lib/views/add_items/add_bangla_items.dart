...
class AddBanglaItems extends StatefulWidget {
  const AddBanglaItems({super.key});

  @override
  State<AddBanglaItems> createState() => _AddBanglaItemsState();
}

class _AddBanglaItemsState extends State<AddBanglaItems> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Bangla Question'),
      ),
